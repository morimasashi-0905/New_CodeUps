...
// page-topボタンをフッターに被らないように
    ...
    // opening
        ...
        mm.add('(max-width:767px)',function(){
            ...
            .to(mvTitles,{autoAlpha:1, duration:1.3, ease:'power1.in'},'-=.5')
            .to('.js-top-mv__button',{autoAlpha:1, duration:1.3, ease:'power1.in'},'<')
        });
        // 768px以上の時
        mm.add('(min-width:768px)',function(){
            openingTL
            .to(mvTitles,{delay:1, autoAlpha:0, duration:1 ,ease:'power4.in', color: '#fff'})
            .to(turtleImages,{delay:.5, y:0,duration:2.5 ,ease:'power4.out', stagger:{each:.2}},'-=.5')
            .to('.js-header',{y:0, duration:1},'-=1.3')
            .to(mvTitles,{autoAlpha:1, duration:2.5, ease:'power4.in'},'-=2.5')
            .to('.js-top-mv__button',{autoAlpha:1, duration:2.5, ease:'power4.in'},'-=2.2')
        });
